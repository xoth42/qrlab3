...
hdf5_name = '1126cooldown_circulator_VNA - Copy (2).hdf5'
...
params.add('gamma1',value = .001, min = 0, max = .001, vary = fix_vary)
params.add('gamma2',value = .0002, min = 0, max = .005, vary = fix_vary)
params.add('gamma3',value = 0, vary = False)
params.add('gamma4',value = .562, min = 0, vary = fix_vary)
params.add('wb',value = 10.808, vary = False)
params.add('wa',value = 10.804, vary = False)
params.add('wp',value = 10.7865, vary = True)
params.add('wn',value = 10.8287, vary = True)
params.add('ga',value = .01893, vary = True)
params.add('ga2',value = .01283, vary = True)
params.add('spl',value = -.08327, vary = fix_vary)
params.add('A',value = .2, vary = fix_vary)
