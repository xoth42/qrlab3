...
parser = OptionParser(usage="C:\Users\Wang_Lab\Documents\SignalHound")
...
(o, args) = parser.parse_args(args = ['C:\Users\Wang_Lab\Documents\SignalHound\\2020-01-24_11h45m46s.bbr'])
...
plt.imshow(pdata,extent=(fmin,fmax,0,(tmax-tmin)/1e3),vmin=o.pmin, vmax=o.pmax,aspect='auto')
plt.ylabel('t[s]')
plt.xlabel('f[MHz]')
plt.colorbar()
