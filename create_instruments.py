...
old_yoko = instruments.create('old_yoko', 'Yokogawa_7651', address = 'GPIB0::03::INSTR')
#old_yoko = instruments.create('old_yoko', 'Yokogawa_7651', address = 'GPIB0:3::INSTR')
...
#                             pulse_len=2000, readout_chan_I=1, readout_chan_Q=2,
#                             acq_chan=4)
#
