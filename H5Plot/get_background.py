# -*- coding: utf-8 -*-
"""
Created on Wed Jun 19 13:34:47 2019
...
#freqs = freqs[900:1100]
#datas = datas[0][900:1100]
...
if fit_S12:
    ...
    params.add('kappa_a', value=3e6, min = 0)#, max = 4e6)#,vary = False)
...
background = datas - fitdata
backgrounddB = 20*np.log10(np.abs(background))
fig.axes[0].plot(freqs/float(1e9), backgrounddB[0],'--' )
fig.axes[1].plot(background[0].real,background[0].imag, '--', label = 'background')
