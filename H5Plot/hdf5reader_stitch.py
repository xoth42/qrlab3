...
tr1 = WignerbyParity.WignerFunction(qubit_info, ef_info, cavity_infoB, t_ge=300, t_gf=0,
                                         amax=1.2, N=13, amaxx=None, Nx=None, amaxy=None, Ny=None,
                                         seq=None, delay=5, saveas=None, bgcor=False, keep_data=False)
time.sleep(1)
tr2 = WignerbyParity.WignerFunction(qubit_info, ef_info, cavity_infoB, t_ge=300, t_gf=0,
                                         amax=1.2, N=13, amaxx=None, Nx=None, amaxy=None, Ny=None,
                                         seq=None, delay=5, saveas=None, bgcor=False, keep_data=False)
