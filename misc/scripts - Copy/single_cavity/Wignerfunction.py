...
class WignerFunction(Measurement2D):
    ...
    def __init__(self, qubit_info, cav_info, dmax, N, seq=None, delay=0, saveas=None, extra_info=None, detunings=None, pi_areas=None, **kwargs):
        ...
        npoints = 2 * len(dx)**2
        super(WignerFunction, self).__init__(npoints, **kwargs)
