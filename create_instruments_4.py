...
qubit1bob2 = instruments.create('qubit1bob2', 'Qubit_Info',
                             deltaf=-108.35e6,
                              pi_amp=.82,
                              pi2_amp=0,
                              drag=0,
...
pump_info = instruments.create('pump_info', 'Qubit_Info',
                             deltaf=-90.025e6,
                              pi_amp=0.642,
                              pi2_amp=0,
                              drag=0,
...
SCpump = instruments.create('SCpump', 'SC5511A', devid='100016B5')    # 3

SCalice = instruments.create('SCalice', 'SC5511A', devid='10001D30')    # 6


SCbob = instruments.create('SCbob', 'SC5511A', devid='10001D31')    # 5
BrickRef = instruments.create('BrickRef', 'LabBrick_RFSource', serial=18239,
                              use_extref=True) 
...
readout = instruments.create('readout', 'Readout_Info', IQe=(1.0), IQg=(0.1),
                           IQe_radius= 1 , rfsource1='ROFG', rfsource2='BrickRef',
...
#refbrick = instruments.create('refbrick', 'LabBrick_RFSource', serial=14511,
#                          use_extref=True)
#PumpBrick = instruments.create('PumpBrick', 'LabBrick_RFSource', serial=17912,
#                          use_extref=True)
#refbrick = instruments.create('refbrick', 'LabBrick_RFSource', serial=14511,
#                          use_extref=True)
...
#SCalice = instruments.create('SCalice', 'SC5511A', devid='10001D31')
...
#                              AWG_PRODUCT = "M3202A",
#                              amps = [1, 1.5, 1, 1.5], ofs = [0, 0, 0, 0])
#
#AWG2 = instruments.create('AWG2', 'Keysight_AWG', chassis = 0, slot = 8,  
#                              AWG_PRODUCT = "M3202A", 
#                              amps = [1, 1, 1, 1], ofs = [0.01, -.027, 0.024, 0.008])
#
