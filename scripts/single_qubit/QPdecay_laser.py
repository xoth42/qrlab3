...
class QPdecay_laser(Measurement1D):
    ...
    def __init__(self, qubit_info, T1_delays, rep_time, meas_per_reptime=1, meas_per_QPinj=None, fit_start='auto', fit_end=None, vg=0.04, ve=7.21, eff_T1_delay=2000.0, inj_len=10e3, extraT1_delays=None, laser_delay = None, laser_plen = 250,  **kwargs):
