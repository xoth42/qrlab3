# -*- coding: utf-8 -*-
"""
Created on Tue Jun 23 14:55:18 2020
...
class Rabi_mixer(Measurement1D):
    ...
    def __init__(self, qubit_info, amps, mixer_info1 , update=False, seq=None, r_axis=0, fix_phase=True,
        ...
        super(Rabi_mixer, self).__init__(len(amps), infos=(qubit_info, mixer_info1), **kwargs)
