# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 11:21:53 2019
...
class T2MeasurementforRamsey(Measurement1D):

    def __init__(self, qubit_info,qubit_sweep,amplitude, delays, detune=0, echotype=ECHO_NONE, necho=1,
                 double_freq=False, laser_power = None, seq=None, postseq=None, Qswitch_infoA=None, Qswitch_infoB=None, **kwargs):
        self.qubit_info = qubit_info
        self.qubit_sweep = qubit_sweep
        ...
        super(T2MeasurementforRamsey, self).__init__(len(delays), infos=(qubit_info,), **kwargs)
...
#            elen = 0
        ...
        for i, dt in enumerate(self.delays):
            s.append(self.seq)
            s.append(Repeat(self.qubit_sweep.rotate(0, 0, amp=self.amplitude), 1))
