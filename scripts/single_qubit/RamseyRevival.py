...
class RamseyRevival(Measurement1D):

    def __init__(self, ge_info, ef_info, delays, detune=0, double_freq=False, seq=None, postseq=None, **kwargs):
        ...
        super(RamseyRevival, self).__init__(len(delays), infos=(ge_info, ef_info), **kwargs)
