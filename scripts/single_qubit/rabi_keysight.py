...
class Rabi_Keysight(Measurement1D):
    ...
    def __init__(self, qubit_info, amps, update=False, seq=None, r_axis=0, fix_phase=True,
        ...
        super(Rabi_Keysight, self).__init__(len(amps), infos=qubit_info, **kwargs)
    ...
    def generate(self):
        ...
        for i, amp in enumerate(self.amps):
            ...
            s.append(Combined([
                ...
                Constant(self.readout_info.pulse_len, amp, chan=int(self.readout_info.readout_chan_I)),
                Constant(self.readout_info.pulse_len, amp, chan=int(self.readout_info.readout_chan_Q)),
            ]))
            s.append(Delay(20))
