# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 18:00:32 2021
...
class TimeRabi_Mixer(Measurement1D):

    def __init__(self, qubit_info,mixer_info1, mixer_info2, times, amp, update=False, seq=None, r_axis=0, fix_phase=True,
        ...
        super(TimeRabi_Mixer, self).__init__(len(times), infos=(qubit_info,mixer_info1, mixer_info2,), **kwargs)
...
#            ]))
            ...
            s.append(Combined([
                Constant(int(self.mixer_info1.w), 1, chan=self.readout_info.acq_chan),
#                Join([Constant(self.readout_info.pulse_len, 1, chan=self.readout_info.readout_chan),Delay(200)]),
                self.mixer_info1.rotate(np.pi, 0),
