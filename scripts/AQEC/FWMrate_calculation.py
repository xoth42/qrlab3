...
c=0.64
d=0.49
A=0.770*np.exp(2.46j)
B=1.314*np.exp(-0.14j)
C=1.114*np.exp(-0.05j)
D=0.991*np.exp(-0.45j)
...
#c=0.59
#d=0.47
#A=0.815*np.exp(2.44j)
#B=1.324*np.exp(-0.14j)
#C=1.153*np.exp(0.01j)
#D=1.017*np.exp(-0.36j)
...
real_Gammaup = 0.72
qubitdecay = 0.135
Gammaups_exp = np.array([0.163, 0.224, 0.294, 0.290, 0.349, 0.385, 0.379, 0.432, 0.461, 0.48, 0.4938, 0.572, 0.692, 0.778, 0.810, 0.847])
