...
#        self.data.create_dataset('freqs', data = self.freqs)
        ...
        self.ampdata = self.data.create_dataset('amplitudes', shape=[1,len(self.freqs)])
        self.phasedata = self.data.create_dataset('phases', shape=[1,len(self.freqs)])
...
#        ax2 = fig.add_subplot(2,1,2)
        ...
        fig.axes[0].plot(self.freqdata[0,:]/float(1e9), self.ampdata[0,:] )
        plt.xlabel('freq(GHz)')
        fig.axes[0].set_ylabel('dB')
        
        fig.axes[1].plot(self.freqdata[0,:]/float(1e9), self.phasedata[0,:] )
