# -*- coding: utf-8 -*-
"""
Created on Thu Aug 20 18:57:05 2020
...
class CavT1_Mixer(Measurement1D):

    def __init__(self, qubit_info, cav_info, mixer_info, mixer_info2, disp, delays, proj_num, seq=None, postseq=None, extra_info=None, bgcor=False,
        ...
        if bgcor:
            npoints *= 2
        super(CavT1_Mixer, self).__init__(npoints, infos=(qubit_info, cav_info, mixer_info, mixer_info2), **kwargs)
...
#                    s.append(Delay(5000))
    ...
    def get_ys(self, data=None):
        ys = super(CavT1_Mixer, self).get_ys(data)
        if self.bgcor:
            return ys[::2] - ys[1::2]
        return ys
