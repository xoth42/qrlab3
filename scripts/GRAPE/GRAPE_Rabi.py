...
class GRAPE_Rabi(Measurement1D):

    def __init__(self, qubit_info, amps, filename, update=False, seq=None, r_axis=0, fix_phase=True,
        ...
        super(GRAPE_Rabi, self).__init__(len(amps), infos=qubit_info, **kwargs)
    ...
    def generate(self):  #That is the original generate function 
        ...
        for i, amp in enumerate(self.amps):
            ...
            s.append(CSVPulse(self.filename, amp, chan=self.qubit_info.sideband_channels[0]))
