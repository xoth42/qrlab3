...
#        seq = Join([seq, qubit2_info.rotate(np.pi/2, X_AXIS)])
        spec = ssbspec.SSBSpec(qubit_info, np.linspace(-50e6, 50e6, 101), seq=seq, plot_seqs=False, proj_func='amplitude',
                               readout = 'readout_IQ',)
