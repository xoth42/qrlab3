...
class ROCavSpectroscopy_keysight_catpumptest(Measurement1D):

    def __init__(self, qubit_info, powers, freqs, plot_type=None, qubit_pulse=False, seq=None, 
                 fwm_info=None, fwm_gen = None, **kwargs):
        ...
        super(ROCavSpectroscopy_keysight_catpumptest, self).__init__(1, infos=(qubit_info, fwm_info,), **kwargs)
