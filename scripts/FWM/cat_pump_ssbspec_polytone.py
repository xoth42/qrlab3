...
class cat_pump_ssbspec_polytone(Measurement1D):
    ...
    def __init__(self, qubit_info, qubit_fock_info, fwm_ssb_info, fwm_info_list, detunings, 
        ...
        self.fwm_ssb_info = fwm_ssb_info
...
#        for df in self.detunings:
            ...
            g = DetunedSum('SQUARE', int(self.delay), chans=self.fwm_ssb_info.sideband_channels)                
            if df != 0:
                period = 1e9 / df
            else:
                period = 1e50
