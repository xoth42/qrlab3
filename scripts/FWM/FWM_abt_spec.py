...
class FWM_abt_spec(Measurement1D):

    def __init__(self, qubit_info, cav_info, fwm_gen, delay, disp, freqs, power, fwm_channel, switch_channel, 
        ...
        super(FWM_abt_spec, self).__init__(npoints, infos=(qubit_info, cav_info), residuals=False, **kwargs)
