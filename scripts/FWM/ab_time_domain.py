...
class ab_time_domain(Measurement1D):
    ...
    def __init__(self, fwm_info, drive_info, qubit_list, delays, drive_amp, fwm_switch, 
                 fwm_amp=0, seq=None, postseq=None, bgcor=False, **kwargs):
    ...
    def generate(self):
        ...
        for info in self.qubit_list:
            ...
            for dt in self.delays:
                ...
                if dt > 0:
                    if self.fwm_amp !=0 :                        
                        s.append(Combined([Constant(int(dt), self.drive_amp, chan=self.drive_info.sideband_channels[0]),
