...
if 1: #SSB cavspec
    ...
    cspec = ssbcavspec.SSBCavSpec(qubit_info, cavity_infoB, np.linspace(-2e6, 2e6, 71),
...
if 0: # figure out how fast the kerr spins the cavity
...
#        seq.append(sequencer.Delay(dt))
        seq = sequencer.Join([cB(1, 0), sequencer.Delay(dt), cB(1, 0), cB(-1, 0)])
