...
class SSBCavSpec_switch(Measurement1D):

    def __init__(self, qubit_info, cav_info, detunings, switch_channel, seq=None, postseq=None, extra_info=None, saveas=None, Qswitch_infoB=None, **kwargs):
        ...
        super(SSBCavSpec_switch, self).__init__(len(detunings), residuals=False, infos=(qubit_info, cav_info,), **kwargs)
    ...
    def generate(self):
        ...
        for i, df in enumerate(self.detunings):
            ...
            s.append(Combined([
                        g(),
                        Constant(int(self.cav_info.w_selective*4.0), 1, chan=self.switch_channel)
                    ]))
