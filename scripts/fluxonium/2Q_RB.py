...
#        rnd.seed(randomize)
        ...
        for j in range(N_cliffords):
            ...
            self.add_twoQ_clifford(rndnum, cliffordSeq1, cliffordSeq2, pulseSeq1, pulseSeq2, generator = generator)
            # get recovery gate seq
            (recoverySeq1, recoverySeq2) = self.get_recovery_gate(
                    cliffordSeq1, cliffordSeq2, generator = generator)
        ...
        for i in range(N_cliffords):
            ...
            s.append(Combined([recoverySeq1[i+1], recoverySeq2[i+1]]))
            s.append(Combined([
...
#                    self.add_gate(qubit=qubits_to_benchmark, gate=gate_seq)
    ...
    def get_recovery_gate(self, gate_seq_1, gate_seq_2, generator = 'CNOT'):
        ...
        for i in range(total_num_cliffords):
            recovery_seq_1 = []
            recovery_seq_2 = []
            add_twoQ_clifford(i, recovery_seq_1, recovery_seq_2, generator = generator)
    ...
    def add_singleQ_clifford(index, gate_seq, qubit, pad_with_I=True):
    ...
    def add_twoQ_clifford(index, gate_seq_1, gate_seq_2, pulse_seq_1, pulse_seq_2, generator = 'CNOT'):
    ...
    def add_singleQ_S1(index, gate_seq, qubit):
    ...
    def add_singleQ_S1_X2p(index, gate_seq, qubit):
    ...
    def add_singleQ_S1_Y2p(index, gate_seq, qubit):
    ...
    def add_singleQ_S1_Z2p(index, gate_seq, qubit):
    ...
    def add_CNOT_like_twoQ_clifford(index, gate_seq_1, gate_seq_2, **kwargs):
        ...
        if generator == 'CZ':
            ...
            add_singleQ_S1_Y2p(index_4, gate_seq_2, qubit=2)
            ...
            add_singleQ_S1(index_3, gate_seq_1, qubit=1)
            add_singleQ_S1_Z2p(index_4, gate_seq_2, qubit=2)
