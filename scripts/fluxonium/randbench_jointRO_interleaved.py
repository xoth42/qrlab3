...
class Interleaved_1QRB(Measurement1D):
    ...
    def __init__(self, qubit_info, qubit2_info, num_cal_points, n_gates_start, n_gates_stop, n_gates_step, seq=None, postseq=None, **kwargs):
        ...
        super(Interleaved_1QRB, self).__init__(4*n_points, infos=(qubit_info,qubit2_info), **kwargs)
...
#                    s.append(Delay(5))
                ...
                if rotation2_list[i] in ['A1', 'A2', 'A3', 'A4', 'B1', 'B2', 'B4', 'B5', 'B6']:
                    temp_seq.append(self.seq2_table(rotation2_list[i]))
#                    s.append(Delay(5))
                if rotation2_list[i] in ['B3', 'B7']:
                    temp_seq.append(r2(np.pi, X_AXIS))
                    temp_seq.append(r2(np.pi, Y_AXIS))

                    
            temp_seq.append(self.seq_table(correction_list[n-1]))
            temp_seq.append(self.seq2_table(correction2_list[n-1]))
