# -*- coding: utf-8 -*-
"""
Created on Fri Jun 11 16:23:01 2021
...
class TimeRabi_interleaved(Measurement1D):
    ...
    def __init__(self, qubit_info, qubit_info2, qubit2_info, times, amp, phase, rel_amp, rel_phase, sigma=5, update=False, seq=None, r_axis=0, fix_phase=True,
