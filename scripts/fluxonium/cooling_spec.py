...
class Cooling_spec(Measurement2D):
    ...
    def __init__(self, cool_rfsource, qubit_info, cool_freqs, cool_powers,
        ...
        super(Cooling_spec, self).__init__(npoints, infos=qubit_info, **kwargs)
...
#
    ...
    def analyze(self):
        ...
        zs= np.transpose(self.phasedata)
        plt.figure()


        pc = plt.pcolormesh(self.xs, self.ys, zs)#, cmap=plt.get_cmap('RdBu'))
        plt.colorbar(pc)
#    
