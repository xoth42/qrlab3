...
class Rabi_singlequbit(Measurement1D):

    def __init__(self, qubit_info, qubit_info2, amps, update=False, seq=None, r_axis=0, fix_phase=True, rel_amp=1.0, rel_angle=0.0,
        ...
        super(Rabi_singlequbit, self).__init__(len(amps), infos=(qubit_info,qubit_info2), **kwargs)
