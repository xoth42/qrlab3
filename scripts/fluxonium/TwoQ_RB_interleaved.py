...
#            self.add_ZX90(index, gate_seq_1, gate_seq_2, pulse_seq_1, pulse_seq_2, length1, length2, generator = generator)
...
#    def add_ZX90(self, index, gate_seq_1, gate_seq_2, pulse_seq_1, pulse_seq_2, length1, length2, generator='ZX90', **kwargs):
#        r = self.qubit_info.rotate
#        r2 = self.qubit2_info.rotate
#        r3 = self.twoQ_info.rotate
#        r4 = self.cancel_info.rotate
...
#            gate_seq_2.append(r2(-np.pi/2, X_AXIS))
        ...
        if generator == 'CNOT':
            ...
            gate_seq_1.append('I')
            gate_seq_2.append('Y2m')
            pulse_seq_1.append(Delay(q_len1))
            pulse_seq_2.append(r2(-np.pi/2, Y_AXIS))
            length1[0] = length1[0] + q_len1
            length2[0] = length2[0] + q_len2
