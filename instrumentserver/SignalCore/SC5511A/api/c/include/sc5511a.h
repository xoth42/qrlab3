 ...
 * Rev 2.0
 *
 * Rev Notes:	(1)Added set_rf_phase() to make changes to the phase of the
 *				signal. 
 *				(2) Change the sc5511a_device_handle_t to HANDLE, a void pointer 
 ****************************************************************************
 * SC5511A header file 
*/
...
#  define RF_PHASE							0x13    // phase of the signal
