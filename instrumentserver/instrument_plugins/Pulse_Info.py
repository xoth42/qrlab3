...
class Pulse_Info(Instrument):
    ...
    def add_rotation_parameters(self, suffix='', rotations=ROTATIONS):
        self.add_parameter('sideband_channels'+suffix, type=types.StringType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
                set_func=lambda x: True,
        ...
        self.add_parameter('rotation'+suffix, type=types.StringType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
                option_list=rotations,
                set_func=lambda x: True, value='Gaussian',
                gui_group='rotation'+suffix,
                )
        self.add_parameter('w'+suffix, type=types.FloatType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
                set_func=lambda x: True, value=10,
                doc='For Gaussian rotations sigma, for others the pulse width',
                gui_group='rotation'+suffix,
                )
        self.add_parameter('pi_amp'+suffix, type=types.FloatType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
        ...
        self.add_parameter('pi2_amp'+suffix, type=types.FloatType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
                set_func=lambda x: True, value=0,
                doc='The amplitude for a pi/2 pulse',
                gui_group='rotation'+suffix,
                )
        self.add_parameter('drag'+suffix, type=types.FloatType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
                set_func=lambda x: True, value=0,
        ...
        self.add_parameter('oct_filepath'+suffix, type=types.StringType,
                flags=Instrument.FLAG_SET|Instrument.FLAG_SOFTGET,
                set_func=lambda x: True, value=0,
                doc='',
                gui_group='rotation'+suffix,
