# -*- coding: utf-8 -*-
"""
Created on Thu Feb 07 13:19:05 2019

"Yokogawa_7651_new" tester created to fix the Yoko driver. -Brendan
...
class VISACommand(object):
    ...
    def recieve(self):
        ...
        This is broken and needs to work.
        '''
        result_list = [None]
        try:
            while True:
...
#        self.voltage_function.send() Hash this out to make the Yoko not hop down to 1mV
        if (currSource != 'voltage'):
            currSource = 'voltage'
