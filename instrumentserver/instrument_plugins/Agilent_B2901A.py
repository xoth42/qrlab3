## Modified from the Keithley 2400.py file
## by: Randy
## Added 04/27/2021
...
class Agilent_B2901A(Instrument):
    '''
    This is the python driver for the Agilent source meter
    ...
    def __init__(self, name, address, reset=False):
        super(Agilent_B2901A, self).__init__(name, address=address, term_chars='\r\n')

        '''
        Initializes the Agilent, and communicates with the wrapper.
...
#        self._ramp_current(I)
    ...
    def do_get_current(self):
        ...
        '''
        return self._visainstrument.query(':MEAS?').strip().split(',')[1]
...
#        self._ramp_voltage(V)
    ...
    def do_get_voltage(self):
        ...
        '''
        return self._visainstrument.query(':MEAS?').strip().split(',')[0]
