...
RObrick = instruments.create('RObrick', 'LabBrick_RFSource', serial=18239,
                          use_extref=True)
refbrick = instruments.create('refbrick', 'LabBrick_RFSource', serial=14524,
                          use_extref=True)
qubrick = instruments.create('qubrick', 'LabBrick_RFSource', serial=17912, use_extref=True)
#BobFG = instruments.create('BobFG', 'Agilent_Generator', address = 'USB0::0x0957::0x1F01::MY53270760::0::INSTR')
...
#dig = instruments.create('dig', 'Keysight_DIG', chassis = 0, slot = 4, trigger_only = True)
