# -*- coding: utf-8 -*-
"""
Created on Tue May  5 00:52:23 2020
...
#    print int(title[0:6]) <= 020617
    if int(title[0:6]) <= int('150000') and int(title[0:6]) > int('130000') and title[7:12] =='ROCav':
        print title
...
#        params = lmfit.Parameters()
        ...
        params.add('omega_c', value=10.710e9)#,vary = False)
        ...
        params.add('omega_c2', value=10.712e9)#,vary = False)
...
#pl.errorbar(fields, freq1[2],yerr = freq1_err[2],fmt = 'o',label = 'qubit 2 in f')
...
#pl.errorbar(fields, freq2[2],yerr = freq2_err[2], fmt = 'o',label = 'qubit 2 in f')
pl.ylim(10.709e9,10.718e9)
pl.legend()
