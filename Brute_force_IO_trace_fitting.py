# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 15:18:59 2020
...
param = [wa,wb,ga,ga2,wp,k,spl,wn,gamma1,gamma2,gamma4,A,phi,i_off,r_off]
...
gamma4_lst = np.linspace(gamma4*(1-0),gamma4*(1+0),1)
                                                ...
                                                for f in range(len(phi_lst)):
                                                    for g in range(len(i_off_lst)):
                                                        for h in range(len(r_off_lst)):
                                                            param_trial = [wa_lst[q],wb_lst[w],ga_lst[e],ga2_lst[r],wp_lst[t],k_lst[y],spl_lst[u],wn_lst[o],gamma1_lst[p],gamma2_lst[a],gamma4_lst[s],A_lst[d],phi_lst[f],i_off_lst[g],r_off_lst[h]]
                                                            total_fit = 0
                                                            count += 1
                                                            if count % 100 == 0:
                                                                print count
